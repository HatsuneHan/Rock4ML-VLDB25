...
from tools.transformer.utils.helper import build_mlp
...
class TransformerBlock(Layer):
    def __init__(
        ...
        self.att = MultiHeadAttention(
            num_heads=num_heads, key_dim=embed_dim, dropout=att_dropout, name=layer_name
        )
        self.skip1 = Add()
